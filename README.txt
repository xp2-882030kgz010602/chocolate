...
One might try running the frontend to an insane width, seeing which rules still can support one, then using that for speeding up the search for the backend.
